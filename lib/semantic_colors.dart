...
class SemanticColors {
  ...
  static const Color greenSeniority = Color(0xFF86CC66);
  ...
  static const Color blueSeniority = Color(0xFF89CAF5);

  /// The color used for text/icons on blue seniority backgrounds.
  static const Color onBlueSeniority = Color(0xFF21272C);

  /// The color used for orange seniority levels.
  static const Color orangeSeniority = Color(0xFFF2AD5A);
  ...
  static const Color yellowSeniority = Color(0xFFE5D51A);

  /// The color used for text/icons on yellow seniority backgrounds.
  static const Color onYellowSeniority = Color(0xFF2C2B21);
}