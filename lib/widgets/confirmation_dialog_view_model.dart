...
class ConfirmationDialogViewModel extends ViewModel {
  ...
  String get _actionToTitleCase =>
      actionName[0].toUpperCase() + actionName.toLowerCase().substring(1);

  String get confirmButtonText =>
      _actionToTitleCase == "Cancel" ? "Yes, Cancel" : _actionToTitleCase;
  ...
  final RoundedLoadingButtonController confirmButtonController =
